...
public final class LoreContainsFunction implements Matcher<String> {

    @Override
    public @NonNull String name() {
        return "lore_contains";
    }

    @Override
    public @NonNull Component description() {
        return Component.translatable("hopplet.filter.function.lore_contains.description");
    }
