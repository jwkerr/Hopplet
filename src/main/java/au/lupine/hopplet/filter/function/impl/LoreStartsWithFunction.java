...
public final class LoreStartsWithFunction implements Matcher<String> {

    @Override
    public @NonNull String name() {
        return "lore_starts_with";
    }

    @Override
    public @NonNull Component description() {
        return Component.translatable("hopplet.filter.function.lore_starts_with.description");
    }
    ...
    public boolean matches(@NonNull Context context, @NonNull String argument) {
        ...
        return lore.startsWith(argument);
    }
}
